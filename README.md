...
| #5 `0xefb495a0...` | **BTC perp via Aster L1 — verifiable PnL demo** | **real Aster trade ran, Underwriter posted `VERIFIED` review on chain** | 0.953 USDC/share |

Plus **3 underwriter reviews** on chain — 1 LLM-generated, 1 3rd-party, and **1 cryptographically verified** against Aster L1 trade history (vault #5).
